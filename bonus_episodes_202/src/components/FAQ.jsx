                    ...
                    <ul className="basis-1/2">
                        <li className='group'>
                            <button className="relative  flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10" aria-expanded="false">
                                <span className="flex-1 text-base-content">Lorem ipsum, dolor sit amet consectetur?</span>
                            ...
                            <div className="transition-all duration-300 ease-in-out group-hover:max-h-60 max-h-0 overflow-hidden" style={{ transition: "max-height 0.3s ease-in-out 0s" }}>
                                <div className="pb-5 leading-relaxed">
                                    <div className="space-y-2 leading-relaxed"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda cum amet blanditiis quis vero saepe quo veritatis ab dicta ratione cumque, labore velit omnis sequi voluptatem harum distinctio reiciendis eveniet!</div>
                                </div>
                            </div>
                        </li>
                        <li className='group'>
                        ...
                        <li>
                            <a href="#" className='text-orange-500 mt-3 inline-flex font-medium no-underline group px-2 py-2 items-center -tracking-tight'>
                                See more
